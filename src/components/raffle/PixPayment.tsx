...
const BANK_LINKS = [
  {
    ...
    url: "nubank://",
    color: "bg-[#820AD1]",
    hover: "hover:shadow-[#820AD1]/40",
  },
  {
    name: "Itaú",
    url: "itau://",
    color: "bg-[#EC7000]",
    hover: "hover:shadow-[#EC7000]/40",
  },
  {
    name: "Bradesco",
    url: "bradesco://",
    color: "bg-[#CC092F]",
    hover: "hover:shadow-[#CC092F]/40",
  },
  {
    name: "BB",
    url: "bb://",
    color: "bg-[#FBF404] text-blue-900",
    hover: "hover:shadow-[#FBF404]/40",
  },
  {
    name: "Inter",
    url: "inter://",
    color: "bg-[#FF7A00]",
    hover: "hover:shadow-[#FF7A00]/40",
  },
  {
    name: "Santander",
    url: "santander://",
    color: "bg-[#EC0000]",
    hover: "hover:shadow-[#EC0000]/40",
  },
];
        ...
        >
          <Card className="w-full max-w-lg mx-auto card-jackpot border-emerald/20 overflow-hidden">
            ...
            <CardHeader className="text-center pt-8 pb-4">
              ...
              <CardTitle className="text-3xl font-display text-gradient-luck">
                Quase lá!
              </CardTitle>
            ...
            <CardContent className="text-center space-y-6 pb-8">
              <div className="p-5 bg-card/50 backdrop-blur-sm border border-emerald/20 rounded-2xl shadow-inner-slot space-y-3">
                ...
                <div className="flex flex-col items-center gap-1">
                  <span className="font-display text-2xl text-emerald animate-pulse">
                    ANALISANDO
                  </span>
              ...
              <div className="space-y-4 pt-4">
                ...
                <div className="flex flex-col items-center gap-3">
                  <Button
                    variant="outline"
                    className="w-full border-gold/30 hover:bg-gold/10 group h-12 rounded-xl"
      ...
      <Card className="w-full max-w-lg mx-auto card-jackpot border-gold/20 overflow-hidden shadow-2xl">
        ...
        <CardHeader className="text-center space-y-2 pt-6 sm:pt-8 px-4 sm:px-6 relative">
          <motion.div
            ...
            className="absolute top-4 left-4 text-gold/20 hidden sm:block"
          >
            <Coins className="w-8 h-8 animate-float" aria-hidden="true" />
          </motion.div>
          <motion.div
            variants={itemVariants}
            className="absolute top-4 right-4 text-emerald/20 hidden sm:block"
          >
            <Star
              className="w-8 h-8 animate-float [animation-delay:1.5s]"
              aria-hidden="true"
            />
          </motion.div>

          <CardTitle className="text-2xl sm:text-3xl font-display text-gradient-luck drop-shadow-sm">
            Pagamento Seguro
          </CardTitle>
        ...
        <CardContent className="space-y-6 pb-6 sm:pb-8 px-4 sm:px-6">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            >
              ...
              <span className="font-mono font-bold text-warning text-xl">
                {timeLeft}
              </span>
            </motion.div>
            <motion.div
              variants={itemVariants}
              className="flex flex-col items-center justify-center p-4 rounded-2xl bg-emerald/5 border border-gold/20 shadow-inner"
            >
              <span className="text-[10px] text-muted-foreground uppercase font-bold tracking-widest flex items-center gap-1 mb-1">
                <Sparkles className="w-3 h-3 text-gold" aria-hidden="true" />{" "}
                Total
              </span>
              <span className="font-display font-bold text-gradient-gold text-xl animate-pulse-glow">
          ...
          <motion.div
            variants={itemVariants}
            className="group overflow-hidden rounded-2xl border border-dashed border-emerald/30 bg-emerald/5 hover:bg-emerald/10 transition-colors"
          >
            <div className="p-3.5 space-y-2">
              <div className="flex items-center justify-between">
                <span className="text-xs font-bold text-emerald-light uppercase tracking-wider flex items-center gap-1">
                  <Star
                    className="w-3.5 h-3.5 fill-emerald-light"
                    aria-hidden="true"
                  />{" "}
                  Identificação
                </span>
          ...
          <motion.div variants={itemVariants} className="space-y-3 pt-2">
            <div className="flex items-center gap-2">
              ...
              <p className="text-[10px] font-bold text-muted-foreground uppercase tracking-widest whitespace-nowrap px-2">
                Abrir App:
              </p>
              <div className="h-[1px] flex-1 bg-border/30" />
            </div>
